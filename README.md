# RFM Based Customer Segmentation on Automobile Sales Data

## Goal of the project
This project aims to enhance sales revenue for an Automobile bike Company through Customer Segmentation Analysis. Employing a RFM (Recency, Frequency, Monetary) Model, customer segments are delineated based on past purchase behavior, resulting in 11 distinct groups. Utilizing Tableau, a dynamic Sales Dashboard for Customer Segmentation is crafted, while Python is employed for rigorous data quality assessment and analysis, facilitating targeted marketing strategies and optimized sales efforts.

## Datasets Used
The datasets used include:
- __Raw_data.xlsx__: This excel file dataset included the following sheets of data:
  -  __Transactions_data.xlsx__: This dataset included the 20,000 transactions data of the customers across all the different states in Australia.
  -  __CustomerDemographic.xlsx__: This dataset included entire details of the 4000 Customer's Demographics.
  -  __CustomerAddress.xlsx__: This dataset included the address of those 4000 Customers.
  -  __NewCustomerList.xlsx__: This dataset included the 1000 new customers who visted the automobile bike company recently.
